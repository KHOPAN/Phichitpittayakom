...
import org.punlabs.phichitpittayakom.activity.AllGalleryActivity;
...
public class PhichitpittayakomApplication extends AppCompatActivity {
	...
	public void onCreate(Bundle bundle) {
		...
		builder.separate();
		builder.card().title(this.getString(R.string.gallery)).action(cardView -> this.startActivity(new Intent(this, AllGalleryActivity.class)));
	}
